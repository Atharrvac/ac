  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        // Eco-themed variants
        hero: "bg-gradient-hero text-white shadow-strong hover:shadow-glow transition-bounce scale-100 hover:scale-105",
        eco: "bg-gradient-primary text-white shadow-medium hover:shadow-glow animate-pulse-glow",
        reward: "bg-gradient-reward text-reward-foreground shadow-medium hover:shadow-strong animate-coin-bounce",
        collector: "bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-soft border border-secondary/20",
        admin: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-soft border border-accent/20",
        glass: "bg-gradient-card backdrop-blur-md border border-white/20 text-foreground hover:border-white/30 shadow-soft"
      },
      size: {
